(function() {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    const isSekmeler = currentPath.includes('sekmeler.html');
    ...
    navbarContainer.innerHTML = `
      <nav class="navbar">
        ...
        <div class="nav-links" id="nav-links">
          ...
          <a href="sekmeler.html" class="nav-link ${isSekmeler ? 'active' : ''}">
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
              <path d="M12 20h9M3 20v-8a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v8M5 10V6a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v4"></path>
            </svg>
            Excel Düzenle
          </a>
